...
public class SequenceInputStream extends InputStream {
	 ...
	 *         over) from the current underlying input stream without blocking
	 ...
	 * reaches the end of the stream, it calls the <code>close</code> method of
	 ...
	 * <p>
	 * The <code>read</code> method of <code>SequenceInputStream</code> tries to
	 * read the data from the current substream. If it fails to read any
	 * characters because the substream has reached the end of the stream, it
	 * calls the <code>close</code> method of the current substream and begins
	 ...
	 * input operations and cannot be reopened.
	 * <p>
	 * If this stream was created from an enumeration, all remaining elements
