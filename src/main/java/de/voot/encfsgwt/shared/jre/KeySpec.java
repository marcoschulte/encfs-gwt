 ...
 * private key may be specified by its components <code>x</code>, <code>p</code>, <code>q</code>, and <code>g</code> (see {@link DSAPrivateKeySpec}), or it
 * may be specified using its DER encoding (see {@link PKCS8EncodedKeySpec}).
 * 
 * <P>
