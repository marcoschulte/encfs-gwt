 ...
 * standard format (such as X.509 <code>SubjectPublicKeyInfo</code> or PKCS#8),
 * and is returned using the {@link #getEncoded() getEncoded} method. Note: The
 * syntax of the ASN.1 type <code>SubjectPublicKeyInfo</code> is defined as
 * follows:
 * 
 * <pre>
 ...
 * in untrusted environments. See the <a
 * href="../../../platform/serialization/spec/security.html"> Security
 * Appendix</a> of the Serialization Specification for more information.
 * 
 * @see PublicKey
 * @see PrivateKey
 * @see KeyPair
...
public interface Key extends java.io.Serializable {
	 ...
	 * "../../../technotes/guides/security/crypto/CryptoSpec.html#AppA"> Java
