 ...
 * these constructors if the file does exist but for some reason is
 * inaccessible, for example when an attempt is made to open a read-only file
 * for writing.
 * 
 * @author unascribed
 * @since JDK1.0
...
public class FileNotFoundException extends IOException {
	...
	private static final long serialVersionUID = 8170070494739138786L;

	/**
	 * Constructs a <code>FileNotFoundException</code> with <code>null</code> as
	 ...
	 * will be omitted. This private constructor is invoked only by native I/O
	 * methods.
	 * 
	 * @since 1.2
	 */
