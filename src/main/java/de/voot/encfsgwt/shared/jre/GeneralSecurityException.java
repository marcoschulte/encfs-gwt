...
/**
 * The <code>GeneralSecurityException</code> class is a generic security
 * exception class that provides type safety for all the security-related
...
public class GeneralSecurityException extends Exception {
	...
	/**
	 * Creates a <code>GeneralSecurityException</code> with the specified detail
	 * message and cause.
	 * 
	 * @param message
