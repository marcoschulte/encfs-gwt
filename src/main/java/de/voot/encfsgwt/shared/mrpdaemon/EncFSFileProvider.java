...
public interface EncFSFileProvider {
	 ...
	 */
	void isDirectory(String srcPath, final Callback<Boolean, IOException> callback);
	 ...
	 *             Misc. I/O error
	 */
	void exists(String srcPath, final Callback<Boolean, IOException> callback);
	 ...
	 */
	void getFileInfo(String srcPath, final Callback<EncFSFileInfo, IOException> callback);
	 ...
	 */
	void listFiles(String dirPath, final Callback<List<EncFSFileInfo>, IOException> callback);
	 ...
	 */
	void openInputStream(String srcFilePath, final Callback<InputStream, IOException> callback);
